...
Written 2026-09-19 06:30 AM PT. Bot process: STOPPED — no state file advances until an audited restart. Adjudicator digest: Sep 9 6:00 AM PT (10.0 d old) — kill lines are not being graded automatically (com.phmex.lab-adjudicator is unloaded until the bot restart; README Cadence, Gate B).
...
| DONCHIAN_BTC | paper | 12 | +4.70 | 50% | 64 | 2026-09-07 | KILL if paper net <= $-15.00 (spec; fidelity line graded separately) (docs/superpowers/specs/2026-07-16-donchian-ensemble-slot-design.md) | 19.70 above $-15.00 | — | — |
| DONCHIAN_ETH | paper | 18 | +4.23 | 67% | 64 | 2026-09-09 | KILL if paper net <= $-15.00 (spec; fidelity line graded separately) (docs/superpowers/specs/2026-07-16-donchian-ensemble-slot-design.md) | 19.23 above $-15.00 | — | — |
