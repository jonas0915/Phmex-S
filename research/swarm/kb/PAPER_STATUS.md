...
|---|---|---|---|---|---|---|---|---|
| 5m_mean_revert | 57 | -0.10 | 44% | 180 | 2026-09-24 | bot kill switch: negative Kelly (-0.001) after 57 trades | live rail only: auto-demote at $-5.00 (sidecar loss_cap_usdt); no paper kill line registered | — |
...
| informed_flow_btc_alt_cascade_v2 | 6 | -11.44 | 17% | 5 | 2026-09-21 | killed 2026-09-25 (sidecar killed_at) | KILL if n>=50 & net<=0; KILL if net <= $-10.00 at any n; INCONCLUSIVE hard stop n=100 (docs/superpowers/specs/2026-09-20-informed_flow_btc_alt_cascade_v2-prereg.md) | KILL — registered verdict: net $-11.44 <= $-10.00 dollar loss cap at n=6 — KILL; touched .kill_informed_flow_btc_alt_cascade_v2 (bot's .kill_* loop closes the paper book) | 6 trades 1W $-11.44 | WR 16.7% | CI95 lo -3.240 |
