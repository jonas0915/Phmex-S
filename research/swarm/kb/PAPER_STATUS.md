...
Written 2026-09-18 06:30 AM PT. Bot process: STOPPED — no state file advances until an audited restart. Adjudicator digest: Sep 9 6:00 AM PT (9.0 d old) — kill lines are not being graded automatically (com.phmex.lab-adjudicator is unloaded until the bot restart; README Cadence, Gate B).
...
|---|---|---|---|---|---|---|---|---|---|---|
| 5m_mean_revert | paper | 54 | +3.59 | 46% | 174 | 2026-09-07 | live rail only: auto-demote at $-5.00 (sidecar loss_cap_usdt); no paper kill line registered | — | — | — |
