...
Rows 85-103 are killed sub-mechanisms documented in the 21 `reference_*.md` memory files actually read for this task (edge_hunt_exhaustion, new_strategy_feasibility, basis_carry_screen, btc_tsm_kill_test, nobarriers_search, scale_research, vwap_sma_cross, htf_l2_vwap_sma_filter, smallcap_viability, sr_bounce_scan, sr_bounce_lever_lab, mr_edge_search_2026-09-04, mr_overnight_program, mr_universe_scan, mr_ledger_trio, sl_loss_levers, overnight_sweep, gate_quantify, htf_l2_signal_rnd, htf_l2_entry_features, funding_spread_phemex) that were not already captured as their own row 1-76 (several v1 rows compress multiple distinct sub-tests into one line; each compressed sub-test gets its own row here so a later agent can cite it precisely).
...
| 67 | Hour-of-day / pullback hour-bleed gate / day-of-week / tilt / same-symbol re-entry | NULL / stale — Bleed-hour set inverted on current data; worst hour Bonferroni p=0.48; no tilt; date column is 5/2, the earliest of the source's three dates (5/2, 7/2, 7/5) | 01_dead_list.md:82 | 2026-05-02 |
...
| 82 | S1 — Funding-settlement volatility-regime breakout gate (alts) | refuted 2/2 — relabels two already-dead levers (time-of-day gate, taker entries — both killed on this account's own data, rows 7/49/67); fee+drift math needs a 56.5% win rate from a mechanism that is a magnitude finding, not a direction finding | sweep/REPORT.md | 2026-09-16 |
...
| 104 | vol_structure_mm_withdrawal_drift | n=1, net_bps_mean=-161.50, ci95=null (bootstrap needs n>=2), WR=0.0% vs p*(200)=52.875%, per screens/vol_structure_mm_withdrawal_drift/out.json; audit.json verdict CONFIRMED (process only) but findings flag n=1 fails viability item 1, p_boot=1.0 per audit.json:numbers.p_boot; BH not significant, rank 2/5 threshold 0.04 per committee/bh.json | research/swarm/runs/2026-09-19-1451/REPORT.md | 2026-09-19 |
| 105 | vol_structure_gamma_unclamp | n=3, net_bps_mean=-44.83, ci95=[-161.50, 188.50] straddles zero, WR=33.33% vs p*(200)=52.875%, time_to_verdict_weeks=714.09, per screens/vol_structure_gamma_unclamp/out.json; audit.json verdict CONFIRMED (process only), p_boot=1.0 per audit.json:numbers.p_boot; BH not significant, rank 3/5 threshold 0.06 per committee/bh.json | research/swarm/runs/2026-09-19-1451/REPORT.md | 2026-09-19 |
| 106 | cross_asset_btc_shock_lag | n=1518, net_bps_mean=-15.58, ci95=[-22.17,-8.38] excludes zero but entirely negative (opposite sign of the thesis's predicted drift), WR=46.90% vs p*(150)=53.83%, per screens/cross_asset_btc_shock_lag/out.json; audit.json verdict CONFIRMED states mechanism refuted by train-era data, p_boot=1.0 per audit.json:numbers.p_boot; BH not significant, rank 4/5 threshold 0.08 per committee/bh.json | research/swarm/runs/2026-09-19-1451/REPORT.md | 2026-09-19 |
| 107 | cross_asset_ethbtc_regime_rotation | n=729, net_bps_mean=-31.01, ci95=[-45.12,-16.70] entirely negative, WR=45.13% vs p*(200)=52.875%, per screens/cross_asset_ethbtc_regime_rotation/out.json; audit.json verdict CONFIRMED states thesis fails viability on the numbers themselves, p_boot=1.0 per audit.json:numbers.p_boot; BH not significant, rank 5/5 threshold 0.10 per committee/bh.json | research/swarm/runs/2026-09-19-1451/REPORT.md | 2026-09-19 |
| 108 | forced_flows_adl_winner_reversal | n=65, net_bps_mean=-10.92, ci95=[-33.34, 10.45] straddles zero, WR=46.15% vs p*(150)=53.83%, per screens/forced_flows_adl_winner_reversal/out.json; audit.json verdict CONFIRMED, ci_excludes_zero=false, p_boot=1.0 per audit.json:numbers.p_boot; committee not run this run, no committee/*.json artifact exists | research/swarm/runs/2026-09-20-0300/REPORT.md | 2026-09-20 |
| 109 | forced_flows_daily_relever_flow | n=477, net_bps_mean=-34.61, ci95=[-45.40, -23.18] fully negative, WR=38.36% vs p*(150)=53.83%, per screens/forced_flows_daily_relever_flow/out.json; audit.json verdict CONFIRMED (process only), findings state the thesis fails viable item 1/2 and triggers its own pre-registered doa_line, p_boot=1.0 per audit.json:numbers.p_boot; committee not run | research/swarm/runs/2026-09-20-0300/REPORT.md | 2026-09-20 |
| 110 | owner_record_liq_cascade_continuation | n=136, net_bps_mean=-23.89, ci95=[-43.72, -3.85] fully negative, WR=35.29% vs p*(200)=52.875%, per screens/owner_record_liq_cascade_continuation/out.json; audit.json verdict CONFIRMED (process only), findings state the pre-registered DOA line (CI includes zero OR WR below p*200) is triggered on both conditions, recommending kill citing dead rows 6 and 80, p_boot=1.0 per audit.json:numbers.p_boot; committee not run | research/swarm/runs/2026-09-20-0300/REPORT.md | 2026-09-20 |
| 111 | vol_structure_volscale_continuation | n=762, net_bps_mean=-3.81, ci95=[-19.61, 12.21] straddles zero, WR=43.57% vs p*(250)=52.3%, per screens/vol_structure_volscale_continuation/out.json; audit.json verdict CONFIRMED (process only), findings state net_bps_mean negative and CI does not exclude zero while WR is below p*250, p_boot=1.0 per audit.json:numbers.p_boot; committee not run | research/swarm/runs/2026-09-20-0300/REPORT.md | 2026-09-20 |
